...
def main():
    ...
    # data_repo = '/home/pgajo/working/food/datasets/EW-TT-MT_LOC_en-it_U0_S1_Tingredient_P0.25_DROP1_mbert'
    # data_repo = '/home/pgajo/working/food/datasets/EW-TT-MT_LOC_en-it_U1_S0_Trecipe_P0_DROP1_mbert' # unshuffled MT-LOC
    data_repo = '/home/pgajo/working/food/datasets/EW-TT-PE_en-it_U0_S1_Tingredient_P0.25_DROP1_mbert'
    # data_repo = '/home/pgajo/working/food/datasets/EW-TT-PE_en-it_U1_S0_Trecipe_P0_DROP1_mbert' # unshuffled PE
    ...
    device = 'cuda'
    model = BertAligner.from_pretrained(model_repo)#.to(device)
