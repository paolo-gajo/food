...
pattern_list = [
    ...
    {'pattern': r'(\d[-/\.\,\d\s]*)(?:(?:onzas fluidas)|(?:onza fluida)|onzas|onza|oz\.|oz)(?!\w)', 'ratio': 28.35, 'uom': 'g', 'type': 'quantity'},
    {'pattern': r'(\d[-/\.\,\d\sa]*)(?:chili|chilo|lbs?\.?|libbre|pounds|pound|sterline|sterlina)(?!\w)', 'ratio': 0.45, 'uom': 'kg', 'type': 'quantity'},
    {'pattern': r'(\d[-/\.\,\d\s]*)(?:de pulgada|pulgada|pulgadas|\")(?!\w)', 'ratio': 2.54, 'uom': 'cm', 'type': 'quantity'},
    {'pattern': r'(\d[-/\.\,\d\s]*)(?:pinta|pintas)(?!\w)', 'ratio': 473, 'uom': 'ml', 'type': 'quantity'},
    {'pattern': r'(\d[-/\.\,\d\s]*)(?:cuarto|cuartos)(?!\w)', 'ratio': 946, 'uom': 'ml', 'type': 'quantity'},
    {'pattern': r'(\d[-/\.\,\d\s]*)gallon(?!\w)', 'ratio': 3.78, 'uom': 'l', 'type': 'quantity'},

    {'pattern': r'tazz.(?!\w)', 'ratio': 236, 'uom': 'g', 'type': 'uom'},
    {'pattern': r'(?:(?:onzas fluidas)|(?:onza fluida)|onzas|onza|oz\.|oz)(?!\w)', 'ratio': 28.35, 'uom': 'g', 'type': 'uom'},
    {'pattern': r'(?:chili|chilo|lbs?\.?|libbre|pounds|pound|sterline|sterlina)(?!\w)', 'ratio': 0.45, 'uom': 'kg', 'type': 'uom'},
    {'pattern': r'(?:de pulgada|pulgada|pulgadas|\")(?!\w)', 'ratio': 2.54, 'uom': 'cm', 'type': 'uom'},
    {'pattern': r'(?:pinta|pintas)(?!\w)', 'ratio': 473, 'uom': 'ml', 'type': 'uom'},
    {'pattern': r'(?:cuarto|cuartos)(?!\w)', 'ratio': 946, 'uom': 'ml', 'type': 'uom'},
